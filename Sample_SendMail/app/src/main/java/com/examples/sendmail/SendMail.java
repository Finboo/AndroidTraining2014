 ...
 * <br>
 * Note: You are FREE to use this application for your <b>personal use</b>. For example, using this
 * code as a learning or teaching aid is ok. If you can, please give me some credit. <br>
 * <br>
 * Please <b>do not</b> use it for commercial purposes like creating a product for redistribution,
 * etc. <br>
 * <br>
 * I cannot guarantee that your Android OS powered phone will not crash by using this example code.
 * And, all the usual legal yadda yadda applies. :) <br>
 * <br>
